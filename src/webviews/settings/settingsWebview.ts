				...
				switch (e.params.type) {
					...
					case 'commit-uncommitted': {
						const commit = new GitCommit(
							...
							new GitCommitIdentity('我', 'eamodio@gmail.com', new Date('2016-11-12T20:41:00.000Z')),
							new GitCommitIdentity('我', 'eamodio@gmail.com', new Date('2020-11-01T06:57:21.000Z')),
